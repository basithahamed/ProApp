...
import com.databasesdriver.RemoveUserFromTask;
...
public class RemoveTaskRelation extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (new RemoveUserFromTask().deleteUserFromTask(con, uid, tid)){
            ...
            e.printStackTrace();
            // response.getWriter().println("Error while deleting the task exception");
        }
    }
}
